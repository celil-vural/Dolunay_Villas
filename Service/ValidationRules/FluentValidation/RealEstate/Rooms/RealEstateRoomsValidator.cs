...
namespace Service.ValidationRules.FluentValidation.RealEstate.Rooms
{
    public class RealEstateRoomsValidator : AbstractValidator<RoomsDto>
    {
        public RealEstateRoomsValidator()
        {
